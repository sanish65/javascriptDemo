...
{
    console.log('final voice  is activated');
};
...
function speakIt(mssg)
{
    ...
    if(mssg.includes('happy'))
    {
        ...
        speech.text = "hey. you look happy. i will play a song for you";
        play();
    ...
    {
        speech.text = "you look neutral. i will play a song for you";
        play();
    ...
    {
        speech.text = "you look angry right now. Calm down. i will play a song for you";
        play();
...
// //databaseeeeeeeeeeeeeeeeeeeee final 
...
var db2=openDatabase("itemDB","1.0","itemDB",65535);
        ...
        function loadData(){
          ...
          db.transaction(function(transaction){
            ...
            transaction.executeSql(sql,undefined,function(transaction,result){
        if(result.rows.length){
        console.log(result.rows.length+"this is result");
        for(var i=0;i<result.rows.length;i++){
          var row=result.rows.item(i);
          console.log(row, "row object 1");
          var item=row.item;
